...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "📄 Note: This online CV is significantly more detailed than the standard resume format. For a concise single-page version please download the English or French PDF above.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
              window.location.href = "/books/4_3_2_1/";
            },},{id: "books-a-mind-for-numbers",
          ...
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/goldfinch/";
            },},{id: "books-his-dark-materials",
          title: 'His Dark Materials',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/his_dark_materials/";
            },},{id: "books-the-80-20-principle",
          title: 'The 80/20 Principle',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/the_80_20_principle/";
            },},{id: "books-the-brain-that-changes-itself",
          title: 'The Brain That Changes Itself',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/the_brain_that_changes_itself/";
            },},{id: "books-the-godfather",
          title: 'The Godfather',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/the_godfather/";
            },},{id: "books-the-hare-with-amber-eyes",
          title: 'The Hare with Amber Eyes',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/the_hare_with_amber_eyes/";
            },},{id: "books-the-overstory",
          title: 'The Overstory',
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/the_overstory/";
          ...
          description: "",
          section: "Books",handler: () => {
              window.location.href = "/books/twenty_thousand_leagues_under_the_sea/";
          ...
          description: "",
          section: "News",},{id: "projects-3d-brain-tumour-segmentation",
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%73%74%65%66%61%6E.%73%74%72%61%69%6E@%6F%75%74%6C%6F%6F%6B.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/StefanStrain", "_blank");
        },
      },{
        id: 'social-kaggle',
        title: 'Kaggle',
        section: 'Socials',
        handler: () => {
          window.open("https://www.kaggle.com/stefanstrainovic", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/stefanstrainovic", "_blank");
        },
      },{
      id: 'light-theme',
